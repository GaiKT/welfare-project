    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/5">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <div className="relative ">
          ...
          <span className={`absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full px-3 py-1 text-xs font-medium ${
            ...
            {data.usagePercent > 80 ? "เกินงบประมาณเร็วๆนี้" : data.usagePercent > 60 ? "กำลังใช้มาก" : "ปกติ"}
          </span>
        </div>
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          ใช้ไปแล้ว {formatCurrency(data.usedAmount)} จากงบประมาณทั้งหมด {formatCurrency(data.totalBudget)}
        </p>
      </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        ...
        <div>
          ...
          <p className="flex items-center justify-center gap-1 text-base font-semibold text-error-600 dark:text-error-500 sm:text-lg">
