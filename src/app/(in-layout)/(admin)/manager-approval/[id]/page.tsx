...
export default function ManagerApprovalDetailPage() {
  ...
  const handleApprove = async () => {
    if (!confirm("คุณต้องการอนุมัติคำร้องนี้ใช่หรือไม่? การอนุมัติจะทำให้คำร้องเสร็จสมบูรณ์")) return;
  ...
  const canApprove = claim.status === "ADMIN_APPROVED";
          ...
          {claim.adminApprover && (
            <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
              <h3 className="text-lg font-semibold text-green-900 dark:text-green-300 mb-2 flex items-center">
                ...
                ผ่านการอนุมัติจาก Admin
              </h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-green-800 dark:text-green-400">ผู้อนุมัติ</p>
                  <p className="font-medium text-green-900 dark:text-green-300">{claim.adminApprover.name}</p>
                </div>
                {claim.adminApprovedAt && (
                  <div>
                    <p className="text-sm text-green-800 dark:text-green-400">วันที่อนุมัติ</p>
            ...
            {canApprove && (
              <form onSubmit={handleAddComment} className="mb-6">
                ...
                <button
                  ...
                  className="mt-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-400 text-white rounded-lg transition-colors"
                >
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  {processing ? "กำลังดำเนินการ..." : "อนุมัติขั้นสุดท้าย"}
                </button>
                <button
